...
export function PropertyCard({ property, variant = 'default' }: PropertyCardProps) {
  ...
  // Image: compact for carousels, fixed aspect for grid
      ...
      >
        ...
        >
          <div className="flex items-baseline justify-between gap-2 mb-2">
            <span className="text-lg font-bold text-emerald-600 truncate">
              {priceDisplay.amount}
              {priceDisplay.suffix && (
          ...
          <h3 className="font-semibold text-[#1A1A1A] text-base mb-1.5 line-clamp-2 group-hover:text-[#E10600] transition-colors">
            {property.title}
          </h3>
          ...
          <div className="flex gap-2 mt-auto pt-3 border-t border-[#E5E5E5]">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-sm font-medium border border-[#E5E5E5] text-[#1A1A1A] hover:bg-[#F5F5F5] hover:border-[#E10600]/40 transition-colors"
            >
            ...
            <a
              ...
              onClick={(e) => e.stopPropagation()}
              className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-sm font-medium bg-[#25D366] hover:bg-[#1DA851] text-white transition-colors"
            >
