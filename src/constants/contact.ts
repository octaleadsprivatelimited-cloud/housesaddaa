/**
 * Shared contact info for Contact page, Footer, and CTAs.
 * Primary phone is the main number; alternatePhone is additional (do not replace).
 */
export const CONTACT = {
  ...
  mapEmbed: 'https://maps.google.com/maps?q=8-1-284%2COU+Colony%2C+Shaikpet%2C+Hyderabad%2C+Telangana+500104&t=&z=14&ie=UTF8&iwloc=&output=embed',
  mapShareUrl: 'https://maps.app.goo.gl/h4Pzv6uoowF3czKT6',
} as const;
